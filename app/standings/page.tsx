...
export default async function StandingsPage() {
  ...
  const teamColors: any = {
    ...
    "مرسدس": "bg-[#00D2BE]", "فراری": "bg-[#DC0000]", "مکلارن": "bg-[#FF8700]", "ردبول": "bg-[#0600EF]", "استون مارتین": "bg-[#006F62]", "الپین": "bg-[#FF87BC]", "ویلیامز": "bg-[#005AFF]", "هاس": "bg-[#B6BABD]", "آئودی": "bg-[#9c2931]", "کادیلاک": "bg-[#9FA3A6]", "ریسینگ بولز": "bg-[#6692FF]",
